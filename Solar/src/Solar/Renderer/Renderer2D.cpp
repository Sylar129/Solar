...
namespace Solar {
    ...
    void Renderer2D::Init() {
        ...
        Ref<Solar::VertexBuffer> squreVB;
        squreVB = VertexBuffer::Create(squareVertices, sizeof(squareVertices));
        ...
        squreIB = IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
